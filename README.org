...
*** Easy Method
1. Download and extract [[https://github.com/darkstego/ergoarabic/releases/download/v1.0/ergoarabic-win.zip][ergoarabic-win]].
...
** Mac
*** Easy Method
1. Download and Extract [[https://github.com/darkstego/ergoarabic/releases/download/v1.0/ergoarabic-macos.zip][ergoarabic-macos]].
